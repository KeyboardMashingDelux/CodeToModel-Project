...
";
        ...
        public async Task analyzeVerify() {
            DiagnosticResult interfaceModfiers = new DiagnosticResult(CTMDiagnostics.RequiredModelInterfaceKeyword).WithLocation(12, 5).WithArguments("Example", "ISentence");
            DiagnosticResult listToExpression = new DiagnosticResult(CTMDiagnostics.IListExpressionInstead).WithLocation(12, 5);
            DiagnosticResult dumbResult = new DiagnosticResult(CTMDiagnostics.ModelInterfaceNoModelMetadataDescriptor).WithLocation(12, 5);
