...
";
        ...
        private static void configureTestState(SolutionState testState, string source, params DiagnosticResult?[]? expected) {
            ...
            testState.AdditionalReferences.Add(MetadataReference.CreateFromFile("D:\\Tools\\Microsoft Visual Studio\\Repos\\Code First Modeling\\CTMTestAssemblies\\bin\\Debug\\net9.0\\CTMTestAssemblies.dll"));   
        }
