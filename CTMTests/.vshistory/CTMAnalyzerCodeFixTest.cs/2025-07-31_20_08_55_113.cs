...
";
        ...
        const string assemblyAttributesSource = @"
using NMF.Models;

[assembly: ModelMetadata(""http://github.com/CodeToModel"", ""CodeToModel.Example.Sentence.nmeta"")]
[assembly: ModelMetadata(""http://github.com/CodeToModelTest"", ""TEST.ANALYZER.ASSEMBLY.UNESCESSARY.nmeta"")]
";
        ...
        private static void configureTestState(SolutionState testState, string source, params DiagnosticResult?[]? expected) {
            ...
            testState.Sources.Insert(0, ("AssemblyAttributes.cs", SourceText.From(assemblyAttributesSource)));
