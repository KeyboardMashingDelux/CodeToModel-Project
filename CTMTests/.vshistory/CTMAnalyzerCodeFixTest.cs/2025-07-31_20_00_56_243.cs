...
";
        ...
        private static void configureTestState(SolutionState testState, string source, params DiagnosticResult?[]? expected) {
            ...
            var metadataAssemblyPath = Path.Combine(TestContext.CurrentContext.TestDirectory, "CTMTestAssemblies.dll");
            testState.AdditionalReferences.Add(metadataAssemblyPath);   
        }
