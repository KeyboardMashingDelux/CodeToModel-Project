...
";
        ...
        public async Task analyzeVerify() {
            ...
            DiagnosticResult dumbResult = new DiagnosticResult(CTMDiagnostics.ModelInterfaceNoModelMetadataDescriptor).WithLocation(1, 1);
            CSharpAnalyzerTest<CTMDiagnosticAnalyzer, DefaultVerifier> analyzerTest = new();
            configureTestState(analyzerTest.TestState, TestCode, interfaceModfiers, listToExpression, dumbResult);
