...
namespace CTMGenerator {
    public class CTMDiagnostics {
        ...
        public static readonly DiagnosticDescriptor RequiredModelInterfaceKeywords = new(
            id: "CTM004",
            title: "Missing model Interface modifier",
            messageFormat: "Model Interface {0} does not extend IModelElement or has the partial modifier",
            category: Category,
            defaultSeverity: DiagnosticSeverity.Error,
            isEnabledByDefault: true);
