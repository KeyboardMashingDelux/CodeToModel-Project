...
namespace CTMGenerator {
    public class CTMDiagnostics {
        ...
        public static readonly DiagnosticDescriptor IListExpressionInstead = new(
            ...
            messageFormat: "Type of Field {0} is not supported, use IListExpression instead",
            category: Category,
            defaultSeverity: DiagnosticSeverity.Error,
            isEnabledByDefault: true);
        ...
        public static readonly DiagnosticDescriptor ISetExpressionInstead = new(
            id: "CTM006",
            title: "Unsupported collection type",
            messageFormat: "Type of Field {0} is not supported, use ISetExpression instead",
            category: Category,
            defaultSeverity: DiagnosticSeverity.Error,
            isEnabledByDefault: true);
        ...
        public static readonly DiagnosticDescriptor IOrderedSetExpressionInstead = new(
            id: "CTM007",
            title: "Unsupported collection type",
            messageFormat: "Type of Field {0} is not supported, use IOrderedSetExpression instead",
            category: Category,
            defaultSeverity: DiagnosticSeverity.Error,
            isEnabledByDefault: true);
