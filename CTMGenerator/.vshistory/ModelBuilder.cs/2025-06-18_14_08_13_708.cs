...
namespace CTMGenerator {
    ...
    public class ModelBuilder {
        ...
        public string? name, prefix, suffix, path;
        ...
        public string DoCreateCode() {
            ...
            var ccu = MetaFacade.CreateCode(Namespace, GetAmbientNamespaceName(name));
            ...
            // Creates actual code 
            //MetaFacade.GenerateCode(ccu, ccu);
        }

        public string GetAmbientNamespaceName(string namespaceName) {
