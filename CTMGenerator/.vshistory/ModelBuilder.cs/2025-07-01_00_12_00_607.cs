...
namespace CTMGenerator {
    ...
    public class ModelBuilder {
        ...
        private Dictionary<string, IReference> RefsForTypes;
        ...
        public void CreateReferences() {
            foreach (var item in RefsForTypes) {
                string refName = item.Key;
                IReference refAddType = item.Value;
