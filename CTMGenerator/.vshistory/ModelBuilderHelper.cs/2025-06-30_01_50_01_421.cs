...
namespace CTMGenerator {
    public class ModelBuilderHelper {
            ...
            foreach (var property in properties) {
                ...
                if (IsPrimitive(specialType)) {
                    ...
                    Reference reference = new() {
                        ...
                        IsOrdered = IsOrdered(property.Type.GetType()),
        ...
        public static bool IsOrdered(SpecialType specialType) {
            IListExpression.

            switch (specialType) {
                case IListExpression:
                case IOrderedSetExpression:
                    return true;
                default:
                    return false;
            }
        ...
        public static bool IsUnique(SpecialType specialType) {
            switch (specialType) {
                case IOrderedSetExpression:
                case ISetExpression:
                    return true;
        ...
        public static int GetUpperBound(ImmutableArray<AttributeData> propertyAttributes) {
            ...
            var ca = attribute?.ConstructorArguments;
            return (int)(ca?[0].Value ?? -1); // TODO -1 bei Collecton sonst 1
        }
        ...
        public static (string fullName, string name, string ambientName, string prefix, string suffix) GetFilenameInfo(string? filename) {
            ...
            string fullName = parts[parts.Length - 2 .. 1];
            string name = parts[parts.Length - 2];
            string ambientName = parts[parts.Length - 2];
