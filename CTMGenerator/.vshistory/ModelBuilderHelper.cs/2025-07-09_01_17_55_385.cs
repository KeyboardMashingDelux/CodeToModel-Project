        ...
        public static IType? GetPrimitiveType(SpecialType specialType) {
            ...
            switch (specialType) {
                case SpecialType.System_Boolean:
                    return ResolvePrimitve(typeof(bool).Name);
                case SpecialType.System_Byte:
                case SpecialType.System_SByte:
                    return ResolvePrimitve(typeof(byte).Name);
                case SpecialType.System_Int16:
                case SpecialType.System_UInt16:
                    return ResolvePrimitve(typeof(short).Name);
                case SpecialType.System_Int32:
                case SpecialType.System_UInt32:
                    return ResolvePrimitve(typeof(int).Name);
                case SpecialType.System_Int64:
                case SpecialType.System_UInt64:
                    return ResolvePrimitve(typeof(long).Name);
                case SpecialType.System_Char:
                    return ResolvePrimitve(typeof(char).Name);
                case SpecialType.System_Double:
                    return ResolvePrimitve(typeof(double).Name);
                case SpecialType.System_Single:
                    return ResolvePrimitve(typeof(float).Name);
                case SpecialType.System_String:
                    return ResolvePrimitve(typeof(string).Name);
                case SpecialType.System_Object:
                    return ResolvePrimitve(typeof(object).Name);
                case SpecialType.System_DateTime:
                    return ResolvePrimitve(typeof(DateTime).Name);
                case SpecialType.System_Decimal:
                    return ResolvePrimitve(typeof(decimal).Name);
                default:
                    return null;
            }
        }

        public static IPrimitiveType ResolvePrimitve(string primitiveName) {
