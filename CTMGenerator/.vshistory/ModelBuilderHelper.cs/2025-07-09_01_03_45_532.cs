        ...
        public static IType? GetPrimitiveType(SpecialType specialType) {
            ...
            switch (specialType) {
                case SpecialType.System_Boolean:
                    return ((IPrimitiveType)(MetaRepository.Instance.Resolve($"http://nmf.codeplex.com/nmeta/#//{typeof(bool).Name}")));
                case SpecialType.System_Byte:
                    return ((IPrimitiveType)(MetaRepository.Instance.Resolve($"http://nmf.codeplex.com/nmeta/#//{typeof(byte).Name}")));
                ...
                case SpecialType.System_Object: // Don't use?
                    return ((IPrimitiveType)(MetaRepository.Instance.Resolve("http://nmf.codeplex.com/nmeta/#//String")));
                default:
                    return null;
            }
        }
