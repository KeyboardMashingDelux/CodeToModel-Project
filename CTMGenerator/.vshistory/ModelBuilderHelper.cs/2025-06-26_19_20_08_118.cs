...
namespace CTMGenerator {
    public class ModelBuilderHelper {
        ...
        public static (List<IReference> references, List<IAttribute> attributes) ConvertProperties(List<IPropertySymbol> properties) {
            ...
            foreach (var property in properties) {
                ...
                if (IsPrimitive(specialType)) {
                    ...
                    string? oppositeName = GetFirstString(propertyAttributes, nameof(OppositeAttribute));
        ...
        public static string GetInheritance(ITypeSymbol element) {
            var interfaces = element.Interfaces;
            List<string> inheritance = [];
            foreach (var interfaceSymbol in interfaces) {
                var interfaceAttributes = interfaceSymbol.GetAttributes();
                if (interfaceAttributes.Any(a => IsLibAttributeClass(a.AttributeClass, nameof(ModelInterface)))) {
