...
namespace CTMGenerator {
    [Generator]
    public class ModelGenerator : ModelGeneratorBase, IIncrementalGenerator {
        ...
        public void Initialize(IncrementalGeneratorInitializationContext context) {
            ...
            var assemblyAttributes = context.CompilationProvider.Select((compilation, ct) => compilation.Assembly.GetAttributes());

            var fullProvider = modelParts.Combine(assemblyAttributes);
